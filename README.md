<a href="https://www.qrmagic.io">
  <img alt="QRMagic" src="./public/og-image.png">
  <h1 align="center">QRMagic</h1>
</a>

<p align="center">
  An open source AI search engine. Powered by Zhipu AI.
</p>
...
- Zhipu AI for LLM inference
- GLM-4-Plus model for the main LLM
...
4. Make a request to GLM-4-Plus with the user's question + context & stream it back to the user
5. Make another request to GLM-4-Plus to come up with 3 related questions the user can follow up with

## Cloning & running

1. Fork or clone the repo
2. Create an account at [Zhipu AI](https://open.bigmodel.cn/) for the LLM
...
- [ ] Move back to the Zhipu AI SDK + simpler streaming
